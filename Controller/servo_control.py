...
class LX16A:
  def __init__(self,Port="COM6",Baudrate=115200, Timeout= 0.001):
...
if __name__ == '__main__':
   ...
   r=input ("Press enter to move")
   while True:
     m1.moveservos(50, n, 0, 90, 90, 90, 90, 90)#balance on one leg
     sleep(0.1)
     m1.moveservos(50, n, 0, 90, 90, 90, 90, 9)
     r=input ("Press enter to move")
     m1.moveservos(50, n, 0, 90, 90, 90, 90, 9)#move the leg
     r=input ("Press enter to move")
     m1.moveservos(50, n, 0, 90, 90, 90, 90, 9)
     r=input ("Press enter to move")
     m1.moveservos(50, n, 0, 90, 90, 90, 90, 9) # back to the neutral position
     r=input ("Press enter to move")
   m1.close()     
